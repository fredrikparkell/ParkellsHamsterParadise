...
Simulationer körs bra och snabbt upp till 7 ticks per sekund (142 ms/tick, smällde 1 gång på 21 testsimulationer med 7 ticks per sekund och en range på 2-8 dagar per simulation), men hinner inte med vid 8. Möjligtvis att man hade kunnat optimera nån bit av koden för att få det att bli möjligt att köra några millisekunder snabbare. Samtidigt är det ganska snabbt redan vid 4-5, vilket nog är vad jag hade rekommenderat att köra på som mest för att hinna se utskriften (även om du kan pausa/återstarta under simulationens gång eller se rapporter i efterhand via mina "Look at specific simulation"-funktioner).